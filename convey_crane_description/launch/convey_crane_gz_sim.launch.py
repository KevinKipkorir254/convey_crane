...
def generate_launch_description():
    map_package = get_package_share_directory("convey_crane_description")
    ...
    os.environ["GZ_SIM_RESOURCE_PATH"] = os.path.join(get_package_prefix("convey_crane_description"), "share")
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare("convey_crane_description"),
                    "convey_crane",
                    "robot.urdf.xacro",
                ]
            ),
    ...
    launch_everything = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution(
                [
                    get_package_share_directory("convey_crane_description"),
                    "launch",
                    "all.launch.py",
                ]
            )
